...
\begin{figure}
	...
	\subfloat[Local repulsion $U/t$ depencence.]{
		\includegraphics[width=0.45\textwidth]{../Project/HartreeFock/analysis/hubbard/p=100_Δm=0.0001_Δn=0.01/uM-Setup=A/L=128_β=Inf.pdf}
		\label{appsubfig:mU-beta=Inf}
	}
	\subfloat[Doping $\delta = n-0.5$ dependence.]{
		\includegraphics[width=0.45\textwidth]{../Project/HartreeFock/analysis/hubbard/p=100_Δm=0.0001_Δn=0.01/δM-Setup=A/L=128_β=Inf.pdf}
