\chapter{Mean-field theory solution}\label{chap:mft-solution}
...
\begin{figure}
	\centering
	\input{chapters/mft-solution/pictures/square-nearest-neighbors}
...
\begin{figure}
	...
	\subfloat[Local $s$-wave]{
		\input{chapters/mft-solution/pictures/s-wave-correlator}
	...
	\subfloat[$p_x$-wave.]{
		\input{chapters/mft-solution/pictures/px-wave-correlator}
		\label{subfig:px-wave-correlator}
	}
	\hspace{2em}
	\subfloat[$p_y$-wave.]{
		\input{chapters/mft-solution/pictures/py-wave-correlator}
		\label{subfig:py-wave-correlator}
	}
	\hspace{2em}
	\subfloat[$d_{x^2-y^2}$-wave.]{
		\input{chapters/mft-solution/pictures/d-wave-correlator}
...
\section{Mean-Field theory reciprocal space description}\label{sec:mft-solution-reciprocal-space}
