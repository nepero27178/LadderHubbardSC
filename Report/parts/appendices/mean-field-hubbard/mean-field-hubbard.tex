...
{\color{tabred}[
	To be understood: \citeauthor{fabrizio2022course} \cite{fabrizio2022course} gets a slightly different relation, with $\tanh (\beta E_\mathbf{k}/2)$, because he is not considering the chemical potential. The same result I cannot get here, due to the presence of the Fermi-Dirac factors. This is because I work at fixed density. Am I wrong?
]}
...
\begin{figure}
	...
	\subfloat[Local repulsion $U/t$ depencence.]{
		...
		%\includegraphics[width=0.45\textwidth]{../Project/HartreeFock/analysis/Phase=AF/Scan/Setup=Test256/PlotOrderParameter/xVar=U/pVar=δ/m_t=1.0_Lx=256.0_β=Inf.pdf}
		\label{appsubfig:mU-beta=Inf}
	}
	\subfloat[Doping $\delta = n-0.5$ dependence.]{
		\includegraphics{example-image-b}
		% \includegraphics[width=0.45\textwidth]{../Project/HartreeFock/analysis/Phase=AF/Scan/Setup=Test256/PlotOrderParameter/xVar=δ/pVar=U/m_t=1.0_Lx=256.0_β=Inf.pdf}
...
\begin{figure}
	...
	\subfloat[Local repulsion $U/t$ depencence.]{
		\includegraphics{example-image-a}
		% \includegraphics[width=0.45\textwidth]{../Project/HartreeFock/analysis/Phase=AF/Scan/Setup=Test256/PlotOrderParameter/xVar=U/pVar=δ/m_t=1.0_Lx=256.0_β=100.0.pdf}
		\label{appsubfig:mU-beta=100}
	}
	\subfloat[Doping $\delta = n-0.5$ dependence.]{
		\includegraphics{example-image-b}
%		\includegraphics[width=0.45\textwidth]{../Project/HartreeFock/analysis/Phase=AF/Scan/Setup=Test256/PlotOrderParameter/xVar=δ/pVar=U/m_t=1.0_Lx=256.0_β=100.0.pdf}
