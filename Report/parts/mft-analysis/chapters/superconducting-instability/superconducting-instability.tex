...
\begin{multline*}
	...
	\right] \hat n_{\mathbf{k}\sigma} \hat n_{\mathbf{k}'\sigma}
\end{multline*}
...
\]
Further developing this result and applying Eqns.~\eqref{eq:pairing-dagger-expectation-theoretical}, \eqref{eq:coscos-symmetries-decomposition}, we get
\todo
