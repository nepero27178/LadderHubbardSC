...
\subsection{Ground state energy and BCS condensation}
...
\begin{equation}\label{eq:su-free-energy-leftovers}
...
\end{equation}
as for Eq.~\eqref{eq:reciprocal-space-non-local-interaction-fock-dd-intermediate-su-4}. Notice the presence of a volume factor in the $\mathcal{O}\left(g^2\right)$ correction.
...
\begin{enumerate}
	...
	\item The ``leftovers'' of Eq.~\eqref{eq:su-free-energy-leftovers}, divided by $L_x L_y$.
...
\begin{multline}\label{eq:su-free-energy}
